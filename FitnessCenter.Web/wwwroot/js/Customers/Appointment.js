$(document).ready(function () {
    ...
    function mostrarDetallesCita(event) {
        ...
        $('#title').text('Cita con el entrenador ' + event.extendedProps.trainerName);
    ...
    function manejarClickEnFecha(dateStr) {
        ...
        if (eventsOnDate.length > 0) {
            ...
            $('#hora').text('Fecha: ' + new Date(dateStr).toLocaleDateString('es-ES'));
            $('#book-appointment').show();
            $('#cancel-appointment').show();
        }
    }
